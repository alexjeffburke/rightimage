...
exports.supportedOutputTypes = supportedByEngineToTypesSet(
    converter.isSupportedByEngineNameAndOutputType
);
exports.supportedPipelineOptions = ["maxInputPixels", "maxOutputPixels"];
